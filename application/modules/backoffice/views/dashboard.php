            ...
            <header class="card-header bg-primary">
              ...
              <div class="widget-profile-info">
                <div class="profile-picture">
                  <img src="<?= base_url() ?>template/img/!logged-user.jpg">
                </div>
                    ...
                    <ul class="simple-user-list mb-3">
                      <li>
                        <figure class="image rounded">
                          <img src="<?= base_url() ?>template/img/!sample-user.jpg" alt="Joseph Doe Junior" class="rounded-circle">
                        </figure>
                      ...
                      <li>
                        <figure class="image rounded">
                          <img src="<?= base_url() ?>template/img/!sample-user.jpg" alt="Joseph Junior" class="rounded-circle">
                        </figure>
                      ...
                      <li>
                        <figure class="image rounded">
                          <img src="<?= base_url() ?>template/img/!sample-user.jpg" alt="Joe Junior" class="rounded-circle">
                        </figure>
                ...
                <li>
                  <div class="tm-box">
                    ...
                    <div class="thumbnail-gallery">
                      <a class="img-thumbnail lightbox" href="<?= base_url() ?>template/img/projects/project-4.jpg" data-plugin-options='{ "type":"image" }'>
                        <img class="img-fluid" width="215" src="<?= base_url() ?>template/img/projects/project-4.jpg">
                        <span class="zoom">
