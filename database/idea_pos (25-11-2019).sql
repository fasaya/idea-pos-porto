...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2019 at 11:42 AM
...
(5, 7, 'fasayayaqhsyaa@gmail.com', '', '0', '1', '1'),
...
INSERT INTO `tb_product` (`id_item`, `id_outlet`, `id_kategori`, `nama`) VALUES
(2, 1, 1, 'Thai Tea'),
(3, 1, 1, 'Teh Tarik'),
(4, 2, 1, 'Green Tea');
...
INSERT INTO `tb_product_mod` (`id_mod`, `id_outlet`, `nama`) VALUES
(1, 1, 'Topping Minuman'),
(2, 2, 'Topping Makanan'),
(3, 1, 'Ekstra'),
(4, 1, 'Ekstra dua'),
...
ALTER TABLE `tb_product`
  ...
  ADD CONSTRAINT `tb_product_ibfk_2` FOREIGN KEY (`id_outlet`) REFERENCES `tb_outlet` (`id_outlet`);

--
-- Constraints for table `tb_product_mod`
--
ALTER TABLE `tb_product_mod`
  ADD CONSTRAINT `tb_product_mod_ibfk_1` FOREIGN KEY (`id_outlet`) REFERENCES `tb_outlet` (`id_outlet`);
